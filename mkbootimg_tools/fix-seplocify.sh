...
./sepolicy-inject -s mt_daemon -t device -c dir -p open,read -P sepolicy
./sepolicy-inject -s mt_daemon -t block_device -c dir -p open,read,search -P sepolicy
...
./sepolicy-inject -s mt_daemon -t tmpfs -c dir -p search -P sepolicy
...
./sepolicy-inject -s vsim_daemon -t rootfs -c lnk_file -p getattr -P sepolicy
...
./sepolicy-inject -s radio -t net_radio_prop -cproperty_servicedir -p set -P sepolicy
